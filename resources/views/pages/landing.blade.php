...
@section('title','XiezzNews | Berita Aktual dan Terpercaya Anti Hoax')
    ...
    <div class="grid sm:grid-cols-1 gap-5 lg:grid-cols-4">
      ...
      <a href="detail-MotoGp.html">
        <div
          ...
          <p class="text-slate-400 text-base mt-1">{!! Str::limit($featured->content, 100) !!}</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-5">
      ...
      <div
        ...
        <a href="detail-MotoGp.html">
          ...
          <p class="font-bold text-xl mt-3">{{ $news[0]->title }}
            </p>
      ...
      <img src="{{ asset('storage/'. $news->thumbnail) }}" alt="berita2" class="rounded-xl md:max-h-48" style="height: 250px !important; object-fit: cover;">
